...
import { lessonAssignmentsRoutes } from './modules/lesson-assignments/lesson-assignments.routes.js';
...
async function bootstrap() {
  ...
  await app.register(lessonAssignmentsRoutes, { prefix: '/api/lesson-assignments' });
